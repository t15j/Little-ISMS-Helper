...
final class DsrProcedurePresentCheckTest extends TestCase
{
    private DocumentRepository&MockObject $documentRepository;
    private DsrProcedurePresentCheck $check;

    protected function setUp(): void
    {
        $this->documentRepository = $this->createMock(DocumentRepository::class);
        $this->check = new DsrProcedurePresentCheck($this->documentRepository);
    }

    #[Test]
    public function testPassesWhenPublishedDsrProcedureExists(): void
    {
        ...
        self::assertSame('dsr_procedure_present', $result->checkId);
    }

    #[Test]
    public function testFailsWhenNoDsrProcedure(): void
    {
        $tenant = $this->createMock(Tenant::class);
        $this->documentRepository->method('createQueryBuilder')
    ...
    public function testGapMessageActionable(): void
    {
        ...
        self::assertSame(
            'compliance_check.dsr_procedure_present.fail_message',
            $result->gap['title'],
        );
