...
final class DpiaMethodologyPresentCheckTest extends TestCase
{
    private DocumentRepository&MockObject $documentRepository;
    private DpiaMethodologyPresentCheck $check;

    protected function setUp(): void
    {
        $this->documentRepository = $this->createMock(DocumentRepository::class);
        $this->check = new DpiaMethodologyPresentCheck($this->documentRepository);
    }

    #[Test]
    public function testPassesWhenPublishedDpiaMethodologyExists(): void
    {
        ...
        self::assertSame('dpia_methodology_present', $result->checkId);
    }

    #[Test]
    public function testFailsWhenNoDpiaMethodology(): void
    {
        $tenant = $this->createMock(Tenant::class);
        $this->documentRepository->method('createQueryBuilder')
    ...
    public function testGapMessageActionable(): void
    {
        ...
        self::assertSame(
            'compliance_check.dpia_methodology_present.fail_message',
            $result->gap['title'],
        );
