...
final class BsiSchutzbedarfMethodPresentCheckTest extends TestCase
{
    private DocumentRepository&MockObject $documentRepository;
    private BsiSchutzbedarfMethodPresentCheck $check;

    protected function setUp(): void
    {
        $this->documentRepository = $this->createMock(DocumentRepository::class);
        $this->check = new BsiSchutzbedarfMethodPresentCheck($this->documentRepository);
    }

    #[Test]
    public function testPassesWhenMethodologyPublished(): void
    {
    ...
    #[Test]
    public function testFailsWhenMethodologyMissing(): void
    {
        $tenant = $this->createMock(Tenant::class);
        $this->documentRepository->method('createQueryBuilder')
    ...
    public function testGapMessageActionable(): void
    {
        ...
        self::assertSame(
            'compliance_check.bsi_schutzbedarf_method_present.fail_message',
            $result->gap['title'],
        );
