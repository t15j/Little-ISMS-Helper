...
final class BcmManagementReviewBcmCheckTest extends TestCase
{
    private DocumentRepository&MockObject $documentRepository;
    private BcmManagementReviewBcmCheck $check;

    protected function setUp(): void
    {
        $this->documentRepository = $this->createMock(DocumentRepository::class);
        $this->check = new BcmManagementReviewBcmCheck($this->documentRepository);
    }

    #[Test]
    public function testPassesWhenManagementReviewPublished(): void
    {
    ...
    #[Test]
    public function testFailsWhenManagementReviewMissing(): void
    {
        $tenant = $this->createMock(Tenant::class);
        $this->documentRepository->method('createQueryBuilder')
    ...
    public function testGapMessageActionable(): void
    {
        ...
        self::assertSame(
            'compliance_check.bcm_management_review_bcm.fail_message',
            $result->gap['title'],
        );
