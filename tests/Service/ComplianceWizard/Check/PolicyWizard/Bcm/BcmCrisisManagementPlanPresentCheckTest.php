...
final class BcmCrisisManagementPlanPresentCheckTest extends TestCase
{
    private DocumentRepository&MockObject $documentRepository;
    private BcmCrisisManagementPlanPresentCheck $check;

    protected function setUp(): void
    {
        $this->documentRepository = $this->createMock(DocumentRepository::class);
        $this->check = new BcmCrisisManagementPlanPresentCheck($this->documentRepository);
    }

    #[Test]
    public function testPassesWhenCrisisPlanPublished(): void
    {
    ...
    #[Test]
    public function testFailsWhenCrisisPlanMissing(): void
    {
        $tenant = $this->createMock(Tenant::class);
        $this->documentRepository->method('createQueryBuilder')
    ...
    public function testGapMessageActionable(): void
    {
        ...
        self::assertSame(
            'compliance_check.bcm_crisis_management_plan_present.fail_message',
            $result->gap['title'],
        );
