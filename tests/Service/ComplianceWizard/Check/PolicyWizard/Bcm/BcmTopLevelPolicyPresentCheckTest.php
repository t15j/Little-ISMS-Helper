...
final class BcmTopLevelPolicyPresentCheckTest extends TestCase
{
    private DocumentRepository&MockObject $documentRepository;
    private BcmTopLevelPolicyPresentCheck $check;

    protected function setUp(): void
    {
        $this->documentRepository = $this->createMock(DocumentRepository::class);
        $this->check = new BcmTopLevelPolicyPresentCheck($this->documentRepository);
    }

    #[Test]
    public function testPassesWhenApprovedTopLevelPolicyExists(): void
    {
        ...
        self::assertSame('bcm_top_level_policy_present', $result->checkId);
        self::assertSame('bcm', $this->check->getStandard());
    }

    #[Test]
    public function testFailsWhenTopLevelPolicyMissing(): void
    {
        $tenant = $this->createMock(Tenant::class);
        $this->documentRepository->method('createQueryBuilder')
    ...
    public function testGapMessageActionable(): void
    {
        ...
        self::assertSame(
            'compliance_check.bcm_top_level_policy_present.fail_message',
            $result->gap['title'],
        );
