...
/**
 * W6-D / GDPR Art. 12-22 — confirms a published Data-Subject-Rights
 * (DSR) procedure document exists for the tenant.
 *
 ...
 * DSR procedure template (`standard='gdpr'`, `topic='dsr_procedure'`).
 *
 * Reference: `docs/plans/policy-wizard/06-dpo-input.md` §2.4. Maps to ISO
 * 27701 Cl. 7.3.1-7.3.10 (data-subject obligations).
 */
final class DsrProcedurePresentCheck implements PolicyWizardCheckInterface
{
    public const CHECK_ID = 'dsr_procedure_present';
    private const STANDARD = 'gdpr';
    private const TOPIC = 'dsr_procedure';
