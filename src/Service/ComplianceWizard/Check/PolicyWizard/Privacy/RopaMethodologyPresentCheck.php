...
/**
 * W6-D / GDPR Art. 30 — confirms a published Records-of-Processing
 * methodology document exists for the tenant.
 *
 ...
 * RoPA methodology template (`standard='gdpr'`, `topic='ropa_methodology'`).
 *
 * Reference: `docs/plans/policy-wizard/06-dpo-input.md` §2.2. Maps to ISO
 * 27701 Cl. 7.2.8 (controller's records of processing).
 */
final class RopaMethodologyPresentCheck implements PolicyWizardCheckInterface
{
    public const CHECK_ID = 'ropa_methodology_present';
    private const STANDARD = 'gdpr';
    private const TOPIC = 'ropa_methodology';
