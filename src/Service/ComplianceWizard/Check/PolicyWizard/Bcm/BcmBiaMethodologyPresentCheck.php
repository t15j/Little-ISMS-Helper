...
/**
 * W5-C / ISO 22301 Cl. 8.2.2 — confirms the tenant has a published
 ...
 *
 * Reference: `docs/plans/policy-wizard/04-bcm-input.md` §2.2.
 */
final class BcmBiaMethodologyPresentCheck implements PolicyWizardCheckInterface
{
    public const CHECK_ID = 'bcm_bia_methodology_present';
    private const STANDARD = 'bcm';
    private const TOPIC = 'bia_methodology';
