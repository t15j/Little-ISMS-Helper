...
/**
 * W5-C / ISO 22301 Cl. 8.4.4 + BSI 200-4 Kap. 5.4 — confirms the
 * tenant has a published Crisis Management Plan (Krisenstabsordnung).
 *
 ...
 *
 * Reference: `docs/plans/policy-wizard/04-bcm-input.md` §2.7.
 */
final class BcmCrisisManagementPlanPresentCheck implements PolicyWizardCheckInterface
{
    public const CHECK_ID = 'bcm_crisis_management_plan_present';
    private const STANDARD = 'bcm';
    private const TOPIC = 'crisis_management_plan';
